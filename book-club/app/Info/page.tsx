...
export default function Info() {
  ...
  return (
    ...
    <main className="min-h-screen bg-slate-900 text-white overflow-hidden flex flex-col items-center justify-center pt-24 px-10">
      <Navbar />
        <div className="flex flex-col rounded-2xl items-center bg-slate-950 max-w-3xl">
        ...
        <div className="p-10">
        <ul className="flex p-10 flex-col items-left w-full max-w-8xl list-disc space-y-5 bg-slate-800 rounded-2xl text-lg text-left">
